...
#SBATCH --job-name=exp.python_speed_test.run
#SBATCH --partition=compute2,compute
#SBATCH --chdir=/work/mh0926/m300872/git/speed6/build/run
#SBATCH --nodes=1
...
#SBATCH --mem=0
#SBATCH --output=/work/mh0926/m300872/git/speed6/standalone_speedtest/log/run_set%j.log
#SBATCH --error=/work/mh0926/m300872/git/speed6/standalone_speedtest/log/run_set%j.log
#SBATCH --exclusive
